<template>
  <footer class="site-footer">
    <p>
      MIT Licensed | Copyright © {{ new Date().getFullYear() }} - present
      <a class="link" href="#">Haru</a>
    </p>
    <p>
      Powered by <a class="link" href="https://vitepress.dev/" target="_blank">VitePress</a> |
      Deployed on <a class="link" href="https://vercel.com/" target="_blank"><svg fill="none" height="2500"
          viewBox="0 0 282.72 64" width="2500" xmlns="http://www.w3.org/2000/svg">
          <path
